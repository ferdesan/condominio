...
import { STATUS_LABELS, TYPE_LABELS, unitLabel } from '../correspondence-labels';

/**
 * O repositorio de correspondencias aceita `condominiumId`, `unitId`,
 * `residentId`, `status` e `type`. O condominio vem do shell e nao e um
 * controle; restam os outros quatro — e nada fora dessa lista pode virar
 * controle, porque o backend descarta o resto em silencio e o filtro pareceria
 * funcionar.
 */
...
export function CorrespondenceFilters({ list, units, residents }: CorrespondenceFiltersProps) {
    ...
    <FilterPanel filters={chips} onFilterChange={handleChipChange} onClear={list.clearFilters}>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div className="space-y-1.5 sm:col-span-2">
          <Label htmlFor="correspondence-search">Buscar</Label>
        ...
        <div className="space-y-1.5">
          ...
          >
            <SelectTrigger id="correspondence-resident">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
        ...
        <div className="space-y-1.5">
          ...
          >
            <SelectTrigger id="correspondence-type">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
              <SelectItem value={ANY}>Todos</SelectItem>
      ...
      */}
      <div className="flex items-center gap-2">
        <Checkbox
          id="correspondence-include-deleted"
          checked={list.includeDeleted}
          onCheckedChange={(checked) => list.setIncludeDeleted(checked === true)}
        />
        <Label htmlFor="correspondence-include-deleted" className="font-normal">
          Incluir removidos
        </Label>
      </div>
    </FilterPanel>
