...
describe('renderWithProviders', () => {
  it('injeta o papel e resolve as permissões por ele', () => {
  ...
  it('injeta o condomínio selecionado e aceita a ausência de escolha', () => {
