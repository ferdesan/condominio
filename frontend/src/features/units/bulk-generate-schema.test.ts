...
describe('bulkGenerateSchema', () => {
  it('UT-010: três andares por quatro unidades projetam doze', () => {
  ...
  it('UT-011: zero e 101 andares falham; 1 e 100 passam', () => {
    const message = 'O número de andares deve estar entre 1 e 100.';
  ...
  it('UT-012: a maior grade permitida projeta 5000 e passa na validação', () => {
  ...
  it('UT-013: padrão que produz número acima de 20 caracteres falha antes do envio', () => {
  ...
  it('compoe o número com o indice em dois digitos, como o servidor faz', () => {
